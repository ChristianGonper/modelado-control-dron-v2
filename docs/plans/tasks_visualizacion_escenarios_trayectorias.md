...
- [ ] Task: Anadir Plotly como dependencia del proyecto
...
- [ ] Task: Crear generador HTML 3D posterior
...
- [ ] Task: Integrar visualizacion automatica en `run`
...
- [ ] Task: Anadir bandera `--no-visualization`
...
- [ ] Task: Crear escenario Lissajous
...
- [ ] Task: Actualizar documentacion de uso
...
- [ ] Task: Actualizar documentacion de escenarios
...
- [ ] Task: Actualizar arquitectura de resultados si aplica
...
- [ ] Task: Verificacion final completa
