...
| Terminacion de episodio | Marcar fallos por altura, actitud, limites, no finitos, saturacion persistente o finalizacion normal de trayectorias finitas. | `src/simulador_quad/runner.py` | `tests/test_runner.py` | Escenarios nominales, `waypoint_clean` y futuros escenarios de fallo | `termination_reason`, `termination_cause`. | Implementado |
