...
| Terminacion de episodio | Marcar fallos por altura, actitud, limites, no finitos o saturacion persistente. | `src/simulador_quad/runner.py` | `tests/test_runner.py` | Escenarios nominales y futuros escenarios de fallo | `termination_reason`, `termination_cause`. | Implementado |
