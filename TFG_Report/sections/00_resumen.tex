...
\hline
\multicolumn{2}{|c|}{} \\
\multicolumn{2}{|c|}{\textbf{\large UNIVERSITY OF LEÓN}} \\
\multicolumn{2}{|c|}{\textbf{School of Industrial, Computer and}} \\
\multicolumn{2}{|c|}{\textbf{Aerospace Engineering}} \\
\multicolumn{2}{|c|}{\textbf{\MakeUppercase{\gradoTFG}}} \\
\multicolumn{2}{|c|}{\textbf{Bachelor's Thesis}} \\
\multicolumn{2}{|c|}{} \\
\hline
\multicolumn{2}{|p{0.95\textwidth}|}{\textbf{STUDENT:} \autorTFG} \\
\hline
\multicolumn{2}{|p{0.95\textwidth}|}{%
  ...
  \end{tabular}} \\
\hline
\multicolumn{2}{|p{0.95\textwidth}|}{\textbf{TITLE:} \tituloTFG} \\
\hline
\multicolumn{2}{|p{0.95\textwidth}|}{\textbf{TITLE (EN):} \tituloTFGEnglish} \\
\hline
\multicolumn{2}{|p{0.95\textwidth}|}{\textbf{DEFENSE TERM:} \convocatoriaTFG} \\
\hline
...
\hline
\multicolumn{2}{|p{0.95\textwidth}|}{\textbf{Keywords:} quadcopter, 6DOF simulation, PD control, imitation learning, neural networks.} \\
\hline
\textbf{Student signature:} 
& \textbf{Approved by Supervisors:} \\[1.0cm]
\hline
\end{tabular}
\normalsize
