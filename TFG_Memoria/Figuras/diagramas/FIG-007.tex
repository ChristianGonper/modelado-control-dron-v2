...
\begin{tikzpicture}[
  ...
  % ==========================================
  \node[phasebox] (f1) at (0,0) {\textbf{Fase 1}\\Tests\\(\texttt{pytest})};
  ...
  \node[artbox] (art_latex) at (10.8,-10.65) {Tablas comparativas\\de rendimiento en\\LaTeX};
  ...
  % ==========================================
  \draw[line, draw=black!30] (f4.east) -- (13.0,0) -- (13.0,-9.0) -- (f11.east);
