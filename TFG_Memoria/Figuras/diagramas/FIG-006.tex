...
\begin{tikzpicture}[
  ...
  \node[anchor=south west, font=\sffamily\bfseries, color=purple!80!black] at ($(neural_group.north west) + (0.1,0)$) {Política Neuronal Aprendida (Imitación)};
  \node[anchor=north west, font=\sffamily\bfseries, color=green!60!black] at ($(classic_group.south west) + (0.1,-0.15)$) {Módulo Clásico de Seguridad e Inferencia Interna};
