...
\begin{tikzpicture}[
  ...
  \node[above=0.8cm of sum_pos] (ref_pos) {Referencia\\$\bm{x}_{\text{ref}}, \dot{\bm{x}}_{\text{ref}}$};
  ...
  \node[above=0.6cm of conversion] (ref_guiñada) {Guiñada\\$\psi_{\text{ref}}$};
  ...
  % Conectar lazo interno al mixer (más separación respecto al lazo interno azul)
  \draw[line] (sum_gyro.east) -- node[above, xshift=0.2cm, font=\sffamily\scriptsize] {$\bm{\tau}_B$ [N m]} (mixer.west);
