...
\begin{tikzpicture}[
  ...
  \draw[violet!80!black, line width=1.2pt] ($(zSym)+(-0.08,-0.08)$) -- ($(zSym)+(0.08,0.08)$);
  \node[below=0.12cm of zSym, font=\sffamily\bfseries, color=violet!80!black] {$z_B$ (Abajo, $\otimes$)};
  ...
  \node[draw=gray!30, fill=gray!3, rounded corners=2pt, below=3.0cm of CM, inner sep=5pt, minimum width=2.4cm, font=\sffamily\scriptsize] (leyenda) {
    ...
    \textcolor{red!70!black}{$\bm{\curvearrowright}$} Horario (CW), $s_i = -1$: Rotores 0 y 3 \\
    \textcolor{blue!70!black}{$\bm{\curvearrowleft}$} Antihorario (CCW), $s_i = +1$: Rotores 1 y 2
  };
