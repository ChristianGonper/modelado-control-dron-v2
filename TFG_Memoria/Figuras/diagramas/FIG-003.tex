...
\node[anchor=north east, font=\sffamily\footnotesize\bfseries, text=green!55!black]
  ...
  {F\'{\i}sica\enspace $f_{\mathrm{phys}}=100\,\mathrm{Hz}$,\enspace $T_p=0.01\,\mathrm{s}$};

\node[anchor=north west, font=\sffamily\footnotesize\bfseries, text=orange!70!black]
  at (\xBL+0.20, \yT+\hT-0.14)
  {Telemetr\'{\i}a\enspace $f_{\mathrm{tel}}=10\,\mathrm{Hz}$,\enspace $T_t=0.1\,\mathrm{s}$};
...
\draw[arr] (-4.4, -0.76) -- (-4.1, -0.76) |- node[above, font=\sffamily\scriptsize, pos=0.73]{estado observado} (-1.5, -1.58) -- (-1.5, -0.7);
...
%% ====================================================================
\draw[tarr]
  ([xshift=1.0cm]rk4.south) |- node[left, font=\sffamily\scriptsize\itshape, pos=0.23, align=right] {registro de\\estado real}
  (tel.west);
...
\draw[tarr]
  ...
  -- (0.8, -7.3)
  node[right, font=\sffamily\scriptsize\itshape, pos=0.7, align=left] {registro de\\comandos};
