...
| CIT-009 | `04_control_clasico.tex`, 4.2 | Control PD en cascada de posición y actitud. | Libro o artículo académico de control de cuadricópteros. | cascaded PD position attitude quadrotor control | Pendiente |
| CIT-010 | `04_control_clasico.tex`, 4.3 | Alcance de ajuste manual, Ziegler--Nichols, diseño basado en modelo y búsqueda numérica. | Fuentes originales y revisión académica. | PID tuning Ziegler Nichols quadrotor numerical optimization | Pendiente |
