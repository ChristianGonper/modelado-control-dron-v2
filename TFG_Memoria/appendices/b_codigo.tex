...
El paquete \texttt{simulador\_quad} está dividido por responsabilidades. La
dinámica de cuerpo rígido y los actuadores se encuentran en
\texttt{src/simulador\_quad/dynamics}; los sistemas de referencia, contratos de
datos y utilidades comunes en \texttt{src/simulador\_quad/core}; los
controladores en \texttt{src/simulador\_quad/control}; las trayectorias en
\texttt{src/simulador\_quad/trajectories}; el registro de telemetría en
\texttt{src/simulador\_quad/telemetry}; las métricas en
\texttt{src/simulador\_quad/metrics}; y las salidas gráficas en
\texttt{src/simulador\_quad/visualization}. Los scripts de \texttt{tools/}
orquestan datasets, bancos de expertos, entrenamiento neuronal, ejecución
masiva y consolidación de resultados.
