...
El mismo patrón permite ejecutar escenarios sueltos de diagnóstico durante el
desarrollo. Para las figuras finales del anejo visual, sin embargo, se emplean
las telemetrías ya consolidadas del dataset clásico y no ejecuciones manuales
aisladas.
...
consolidado. Las figuras de telemetría del anejo visual se generan desde el
dataset clásico, donde se guardan las ejecuciones de los PD expertos congelados
usadas en train, validación y test. Cuando se quiere ilustrar transferencia
cruzada se usa la carpeta de resultados de transferencia.
...
\begin{itemize}
  \item \path{results/comparison_all_runs.csv}: Corridas comparables usadas
  ...
  \item Directorio de figuras finales de la memoria en
